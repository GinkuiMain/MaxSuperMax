...
1 - Eu poderia criar um arquivo só com os métodos de direcionamento dos arquivos. Mas, foda-se. Vai ficar assim pq já fiz assim :(

2 - Como um dos criadores do código, eu acho que ele está bom.
